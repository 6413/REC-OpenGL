...
#include <WITCH/BLL/BLL.h>
  ...
  void gl_buffer_is_reseted(shaper_t::ShapeTypeAmount_t ShapeType);
  ...
  struct BlockProperties_t {
    ...
    std::vector<Block_t::init_t> locations;
    fan::opengl::context_t::shader_nr_t shader;
  };
  ...
  void ElementIsPartiallyEdited(
    ...
    auto* bmbase = (bm_BaseData_t*)bm[bmid];
    auto ShapeType = bmbase->ShapeType;
  ...
  void ElementFullyEdited(
    ...
    auto ShapeType = bmbase->ShapeType;
    Block_t& Block = Blocks[ShapeType];
    ElementIsPartiallyEdited(bmid, blid, ElementIndexInBlock, 0, Block.RenderDataSize);
  }
  ...
  ShapeID_t add(
    ...
    if (bmbase->LastBlockElementCount == Block.MaxElementPerBlock_m1) {
      ...
      *BlockID = blnr;
      ...
      ElementFullyEdited(bmnr, bmbase->LastBlockNR, bmbase->LastBlockElementCount);
    }
  ...
  void remove(
    ...
    if (bmbase->LastBlockElementCount != 0) {
      bmbase->LastBlockElementCount--;
      ElementFullyEdited(bmid, gblid, eiib);
      return;
    }
